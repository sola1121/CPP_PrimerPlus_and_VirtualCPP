...
从字符串pos位置开始,查找字符ch,找到返回字符首次出现的位置,否则返回string::npos  
*/
...
const int NUM=26;
const string wordlist[NUM] = { "apiary", "brrtle", "cereal", "danger", "ensign", 
...
int main(){
	...
	while (play=='y'){
		...
		cout<<"Guess my secret word. It has "<<length<<" letters,\n"
			<<"And you guess one letter at a time. You get"<<guesses<<" wrong guesses.\n";
